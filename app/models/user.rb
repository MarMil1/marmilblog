class User < ApplicationRecord
    ...
    # Setting the password reset attributes.
    ...
    # Returning true if a password reset has expired.
    ...
    # Converting email to all lower-case.
    def downcase_email
        self.email = email.downcase
    end

    # Creating and assigning the activation token and digest.
